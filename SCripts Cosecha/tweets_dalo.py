...
ckey = "6L6baRzKBklwlo0psiztzL9AV"
csecret = "wpeWvDm5EuwH5eZeIkG9XOJgXBTMSBm0uUlvV2b9zCu1NDkZA6"
atoken = "325330369-eKJrzRhOyvUtrGvGjhALAHAmvrmE3HRbc6XO1UFe"
asecret = "f9bc60mW7USC8MgO3ypbzUtDwR8DXsRO49decFpALUbPy"
#####################################
...
try:
    ...
    db = server.create('dalo')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['dalo']
    
#Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(track=['#EcuadorDeFamilia', '#UnNuevoFuturo', '#lafuerzadelcambio', '#vamosconfe', '#elmaneslapinta', '#dalopresidente', '@mmcuesta', '#EcuadorSinOdios', '@daloes10'])
