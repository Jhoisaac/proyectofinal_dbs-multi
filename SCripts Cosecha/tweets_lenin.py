...
ckey = "l4SXOrtVxnWAg7kfrYiz7wH1I"
csecret = "AQPQGmXYziwD4CqXrR2h7sKx4jLSzWvzF2mWJVz4KWblpZg5C6"
atoken = "325330369-2ez8uvLzaOXX31lZuPdrF95bXtFzZlnp6J8hSQWV"
asecret = "7ur9apHW6svcmMT34pYalb51X6svk2q0OefIZz6xDKGpt"
#####################################
...
try:
    ...
    db = server.create('lenin')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['lenin']
    
#Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(track=['#LateUnNuevoEcuador', 'lenincontigo.com.ec', '#ElFuturoNoEspera', '#AmigosAlAire ', '#VamosLenin', '@35PAIS', '#ElPaisQueTeImpulsa', '@Lenin'])
