...
ckey = "T3LYoBfNf6bJUBl0sRfV6U3Zu"
csecret = "GRSc3aP0JejhgRZjwdTDgI8bGS1aDMmgqI7J6EvaU8gY6ShhVZ"
atoken = "786303371267280898-e4gMWlB6jmNM8AYumqRQdmkb8d2IH9t"
asecret = "NKCp2L6tt18KHt5hz7MDvUf3nTU78oLYxyEwnsSRQBjcf"
#####################################
...
try:
    ...
    db = server.create('lasso_tweet')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['lassoguillermo_tweet']
    
#Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(track=['@LassoGuillermo', '#VamosPorElCambio', '#1MillonDeEmpleos', '#creo', '@CREOEcuador'])
